...
int main()
{
	...
	char c;
	int a=0, tentativas=3,comparandosenha, comparandologin;
	Cliente cliente[255];
	...
	do
	{
		...
		do{
       	...
       	senha[a]='\0';
       	comparandologin=strcmp(login,"christianSDL");
       	comparandosenha=strncmp(senha,"adm", strlen(senha));
			if(comparandologin==0 && comparandosenha==0)
			{
				setbuf(stdin,NULL);
				printf("\nBem-Vindo");
				break;
